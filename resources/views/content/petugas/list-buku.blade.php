    ...
    <table class="table table-bordered table-hover table-striped " id="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $post->status}}</td>    
                <td>
                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#updatedatabuku<?php echo $post->kode_buku ?>" data-whatever="UpdateBuku"><i class="fas fa-fw fa-pen"></i></button>
                <a href="" type="button" class="btn btn-danger  "><i class="fas fa-fw fa-trash"></i></a>    
                </td>    
            </tr>
            <div class="modal fade" id="updatedatabuku<?php echo $post->kode_buku ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
