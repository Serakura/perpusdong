    ...
    <table class="table table-bordered table-hover table-striped " id="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#updatedatapinjam" data-whatever="UpdateBuku"><i class="fas fa-fw fa-pen"></i></button>
                    <a href="" type="button" class="btn btn-primary  "><i class="fas fa-fw fa-arrow-left"></i></a>  
                    <a href="" type="button" class="btn btn-danger  "><i class="fas fa-fw fa-trash"></i></a>    
                </td>    
            </tr>
            <div class="modal fade" id="updatedatapinjam" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
